...
const POSTS = [
  {
    ...
    time: "2h ago",
    text: "Only 90 days to the 10th Anniversary! The Grand Durbar of Denu Nugoryiyi Zà 2027 is shaping up to be the most spectacular yet. Have you registered yet? 🇬🇭👑",
    likes: "1.2K",
    comments: "184",
  },
  {
    ...
    time: "1 day ago",
    text: "Watch the full highlights from Nugoryiyi Za 2026 — 22 minutes of pure culture, joy and heritage from Denu. The 10th Anniversary edition is next!",
    likes: "8.6K",
    views: "142K views",
  },
  {
